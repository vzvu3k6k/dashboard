...
export const ConnectWallet: React.FC<ConnectWalletProps> = ({
  ...
  // const disconnectFully = disconnect;
  // const disconnectFully = useDisconnect();
  // const network = useActiveChain();
  // const switchNetwork = useSwitchChain();
  ...
  // function handleConnect(_wallet: SupportedWallet) {
  ...
  // const gnosisConnector = undefined;
  // const isGnosisConnectorConnected =
  //   activeConnector?.id === gnosisConnector?.id;

  // const isGnosisConnectorConnected = false;
  ...
  //                       : connectorIdToImageUrl[activeWallet.walletId]
  //                   }
  //                   placeholder="empty"
  //                   alt=""
  //                 />
              ...
              .map((_wallet) => {
                ...
                return (
                  <MenuItem
                    ...
                    //             _wallet.id,
                    //           )
                    //         ? connectorIdToImageUrl[_wallet.id]
